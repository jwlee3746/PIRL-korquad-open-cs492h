...
def normalize_answer(s):
    ...
    def remove_articles(text):
        ...
        regex = re.compile(r'[^ .,?!/@$%~％·∼()\x00-\x7F가-힣]+', re.UNICODE)
        return re.sub(regex, " ", text)
    
    def remain_hangul_english(text):
        hangul = re.compile(r'[^ ㄱ-ㅣ가-힣a-zA-Z0-9[], {}, 【】, <>]+', re.UNICODE)
        return re.sub(hangul, '', s)
    ...
    #return white_space_fix(remain_hangul_english(remove_articles(remove_punc(lower(s)))))
